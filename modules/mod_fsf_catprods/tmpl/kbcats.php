...
<?php $link = FSFRoute::_( 'index.php?option=com_fsf&view=kb&catid=' . $cat['id'] . '&prodid=' . $prodid ); ?>
<div class='faq_mod_category' style='cursor: pointer;'>
	<?php if ($params->get('show_images') && $cat['image']) : ?>
	<div class='faq_mod_category_image'>
	    <a href='<?php echo $link ?>'><img src='<?php echo JURI::root( true ); ?>/images/fsf/kbcats/<?php echo $cat['image']; ?>' width='32' height='32'></a>
	</div>
	<?php endif; ?>
