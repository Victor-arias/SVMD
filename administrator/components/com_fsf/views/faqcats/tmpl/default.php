...
<form action="<?php echo JRoute::_( 'index.php?option=com_fsf&view=faqcats' );?>" method="post" name="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = JRoute::_( 'index.php?option=com_fsf&controller=faqcat&task=edit&cid[]='. $row->id );
